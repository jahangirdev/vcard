...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/front-end/templates/css/vcard3.css')}}">
...
<div class="container">
    <div class="vcard-nine main-content w-100 mx-auto overflow-hidden">
        ...
        <div class="vcard-nine__banner w-100 position-relative">
            <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-banner.png" class="img-fluid banner-image" alt="banner"/>
        ...
        <div class="vcard-nine__profile position-relative">
            <div class="avatar position-absolute top-0 start-50 translate-middle">
                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-profile.png" alt="profile-img" class="rounded-circle"/>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row g-3">
                    <div class="col-sm-6 col-12">
                        <div class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-email.png" alt="email"/>
                            </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-phone.png" alt="phone"/>
                            </span>
                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-birthday.png" alt="birthday"/>
                            </span>
                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-location.png" alt="location"/>
                            </span>
                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                    ...
                    <div class="col-12">
                        <div class="card service-card h-100 w-100 p-3 border-0 d-flex align-items-center flex-sm-row">
                            <div
                                ...
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-service1.png" alt="service"/>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card service-card h-100 w-100 p-3 border-0 d-flex align-items-center flex-sm-row">
                            <div class="service-image rounded-circle d-flex justify-content-center align-items-center justify-content-center">
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-service2.png" alt="service"/>
                            </div>
                            <div class="service-details ms-sm-3 mt-sm-0 mt-3">
                    ...
                    <div class="col-12">
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div
                                ...
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-profile.png" alt="profile"
                    ...
                    <div class="col-12">
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div class="testimonial-user d-flex flex-sm-row flex-column align-items-center justify-content-sm-start justify-content-center">
                                <img src="https://vcards.infyom.com/assets/img/vcard9/vcard9-profile.png" alt="profile" class="rounded-circle"/>
                                <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                    <span class="user-name text-sm-start text-center">Shane Watson</span>
                                    <span class="user-designation text-sm-start text-center">- CEO at Tarsons</span>
                                </div>
                ...
                <div class="card qr-code-card flex-sm-row flex-column justify-content-center align-items-center mt-3 border-0">
                    <div class="mx-2">
                        <div class="qr-profile mb-3 d-flex justify-content-center">
                            <img src="https://vcards.infyom.com/assets/img/vcard3/testimonial-profile.png" alt="qr profile" class="mx-auto d-block rounded-circle"/>
                        </div>
