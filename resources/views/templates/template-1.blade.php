...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/front-end/templates/css/vcard1.css')}}">
...
<div class="container">
    <div class="vcard-one main-content w-100 mx-auto">
        ...
        <div class="vcard-one__banner w-100 position-relative">
            <img src="https://vcards.infyom.com/assets/img/vcard1/vcard-one-bg.png" class="img-fluid" alt="background image"/>
...
{{--            </div>--}}
        ...
        <div class="vcard-one__profile position-relative">
            <div class="avatar position-absolute top-0 start-50 translate-middle">
                <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-profile.png" alt="profile-img" class="rounded-circle"/>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row g-3">
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-email.png" alt="email"/>
                                 </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-birthday.png" alt="email"/>
                                 </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-phone.png" alt="email"/>
                                 </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-location.png" alt="email"/>
                                 </span>
            ...
            <div class="container">
                <div class="row g-3">
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/service1.png" alt="Ui/Ux"/>
                            </div>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/service2.png" alt="Icons"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/service3.png" alt="Branding"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/service4.png" alt="App Design"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/service5.png" alt="Motion"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/service6.png" alt="Development"/>
                            </div>
                            <div class="service-details ms-3">
            ...
            <div class="container">
                <div class="row g-4 pt-5 testimonial-slider overflow-hidden">
                    <div class="col-6">
                        <div class="card testimonial-card position-relative p-2 border-0 w-100">
                            <div class="testimonial-profile position-absolute top-0 start-50 translate-middle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-profile.png" alt="profile"
                    ...
                    <div class="col-6">
                        <div class="card testimonial-card position-relative p-2 border-0 w-100">
                            <div class="testimonial-profile position-absolute top-0 start-50 translate-middle">
                                <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-profile.png" alt="profile" class="rounded-circle m-auto"/>
                            </div>
                            <div class="testimonial-details mt-5">
                                <h4 class="text-center">Melten Lopher</h4>
                                <span class="text-center d-block mb-2">CEO at Codexr</span>
        ...
        <div class="vcard-one__qr-code my-3 py-5 px-3">
            ...
            <div class="qr-code p-3 card d-block mx-auto border-0">
                <div class="qr-code-profile d-flex justify-content-center">
                    <img src="https://vcards.infyom.com/assets/img/vcard1/vcard1-profile.png" alt="qr profile"
                         class="rounded-circle"/>
                </div>
                <div class="qr-code-image mt-4 d-flex justify-content-center">
                    <img src="https://vcards.infyom.com/assets/img/vcard1/vcard-qr.png" alt="qr code"/>
                </div>
            </div>
